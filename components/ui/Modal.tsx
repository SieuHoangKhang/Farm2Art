...
export function Modal({
  ...
  const modalContent = (
    <div
      className="fixed inset-0 z-[2147483647] flex items-center justify-center overflow-y-auto bg-black/50 backdrop-blur-sm p-4 animate-fadeIn"
      onClick={onClose}
    >
      <div
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-sage-200/60 px-6 py-4 bg-gradient-to-r from-emerald-50/50 to-transparent">
          ...
          <button
            onClick={onClose}
            className="flex h-8 w-8 items-center justify-center rounded-full text-stone-400 hover:bg-stone-100 hover:text-stone-600 transition-all font-bold text-lg"
            aria-label="Close"
          >
            ×
          </button>
