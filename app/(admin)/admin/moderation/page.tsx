    ...
    <div className="min-h-screen bg-sage-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Card>
            <CardBody>
              <p className="text-sm text-stone-500">Đã phê duyệt</p>
              <p className="text-3xl font-bold text-green-600">256</p>
            </CardBody>
          </Card>
          <Card>
            <CardBody>
              <p className="text-sm text-stone-500">Bị ẩn</p>
          ...
          {loading ? (
            ...
            <div className="space-y-4 p-6">
              {listings.map(listing => (
                <div key={listing.id} className="p-4 border border-sage-200 rounded-lg hover:bg-sage-50">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <h3 className="font-semibold text-stone-800">{listing.title}</h3>
